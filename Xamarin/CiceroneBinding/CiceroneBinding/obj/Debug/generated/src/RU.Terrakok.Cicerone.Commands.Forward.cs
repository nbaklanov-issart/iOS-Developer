...
namespace RU.Terrakok.Cicerone.Commands {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='ru.terrakok.cicerone.commands']/class[@name='Forward']"
	[global::Android.Runtime.Register ("ru/terrakok/cicerone/commands/Forward", DoNotGenerateAcw=true)]
	public partial class Forward : global::Java.Lang.Object, global::RU.Terrakok.Cicerone.Commands.ICommand {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("ru/terrakok/cicerone/commands/Forward", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (Forward); }
		}

		protected Forward (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_Object_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='ru.terrakok.cicerone.commands']/class[@name='Forward']/constructor[@name='Forward' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/Object;)V", "")]
		public unsafe Forward (string screenKey, global::Java.Lang.Object transitionData)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (Forward)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::RU.Terrakok.Cicerone.Commands.Forward __this = global::Java.Lang.Object.GetObject<global::RU.Terrakok.Cicerone.Commands.Forward> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string ScreenKey {
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.terrakok.cicerone.commands']/class[@name='Forward']/method[@name='getScreenKey' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.Lang.Object TransitionData {
			// Metadata.xml XPath method reference: path="/api/package[@name='ru.terrakok.cicerone.commands']/class[@name='Forward']/method[@name='getTransitionData' and count(parameter)=0]"
